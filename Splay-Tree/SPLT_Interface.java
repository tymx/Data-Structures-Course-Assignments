...
/*
  ...
  insert:
    ...
    return: void, if you need to update size when delegating, consider using a boolean as I mention in 
    BST_Node effect: if the string is already in the tree, then there is no change to
